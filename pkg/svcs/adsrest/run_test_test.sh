...
#go test ${TEST_OPTS} gitlab-odx.oracledx.com/wcai/speedle/pkg/svcs/adsrest -v -tags="runtime_test runtime_cache_test" -run=TestMats
go test ${TEST_OPTS} gitlab-odx.oracledx.com/wcai/speedle/pkg/svcs/adsrest -v -tags="runtime_cache_test" -run=TestMats
